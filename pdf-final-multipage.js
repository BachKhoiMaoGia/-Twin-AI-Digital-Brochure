...
async function generateFinalMultiPagePDF() {
    console.log('🚀 Starting FINAL Multi-Page PDF generation (10 pages each)...');
    ...
    try {
        // Generate Portrait PDF (9:16) - 10 pages
        console.log('📱 Generating 9:16 Portrait PDF (10 pages)...');
        await generatePortraitPDF(browser);
        
        // Generate Landscape PDF (16:9) - 10 pages  
        console.log('🖥️ Generating 16:9 Landscape PDF (10 pages)...');
        await generateLandscapePDF(browser);
        
        console.log('✅ FINAL Multi-page PDF generation completed!');
        console.log('📁 Files created:');
        console.log('   📱 Twin-AI-Brochure-9-16-FINAL-10PAGES.pdf (Portrait - 10 pages)');
        console.log('   🖥️  Twin-AI-Brochure-16-9-FINAL-10PAGES.pdf (Landscape - 10 pages)');
...
async function generatePortraitPDF(browser) {
    ...
    // Add CSS for multi-page PDF with all fixes
    await page.addStyleTag({
        content: `
            ...
            /* CRITICAL: Force page breaks for 10-page PDF */
            .page {
    ...
    await page.pdf({
        path: 'Twin-AI-Brochure-9-16-FINAL-10PAGES.pdf',
        format: 'A4',
    ...
    await page.close();
    console.log('✅ Portrait 9:16 FINAL PDF (10 pages) generated!');
}
...
async function generateLandscapePDF(browser) {
    ...
    await page.pdf({
        path: 'Twin-AI-Brochure-16-9-FINAL-10PAGES.pdf',
        format: 'A4',
    ...
    await page.close();
    console.log('✅ Landscape 16:9 FINAL PDF (10 pages) generated!');
}

// Run the generation
generateFinalMultiPagePDF().catch(console.error);
